...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_client_SOURCE_PREFIX /home/ubuntu/jetsoncar_ws/src/rosserial/rosserial_client)
  set(rosserial_client_DEVEL_PREFIX /home/ubuntu/jetsoncar_ws/devel)
  ...
  set(rosserial_client_INSTALL_PREFIX /home/ubuntu/jetsoncar_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_client' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/jetsoncar_ws/src/rosserial/rosserial_client/${idir}'.  Ask the maintainer 'Paul Bouchier <paul.bouchier@gmail.com>, Mike Purvis <mpurvis@clearpathrobotics.com>' to fix it.")
    endif()
...
set(pkg_cfg_extras "/home/ubuntu/jetsoncar_ws/src/rosserial/rosserial_client/cmake/rosserial_client-extras.cmake")
